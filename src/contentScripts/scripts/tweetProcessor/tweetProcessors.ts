...
export const hideTwitterAds: TweetProcessor = {
  run(element: HTMLElement, { hideTwitterAds, hideTwitterAdsCompletely }) {
    if (element.querySelector('[data-testid="placementTracking') && hideTwitterAds) {
      hideTweet(element, hideTwitterAdsCompletely)
      return true
    }
    return false
  },
...
export const hidePeopleToFollowSuggestion: TweetProcessor = {
  run(element: HTMLElement, { hidePeopleToFollowSuggestion }) {
...
export const hideSubscriptionSuggesstion: TweetProcessor = {
  run(element: HTMLElement, { hideSubscriptionSuggesstion }) {
